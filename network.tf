...
## ASSOCIANDO A ROTA PRIVADA NA SUBNET PRIVADA
...
resource "aws_route_table" "public_rt" {
  ...
  ## ASSOCIANDO A ROTA PUBLICA AO GATEWAY
  route {
    cidr_block = "0.0.0.0/0"
...
## ASSOCIANDO A ROTA PUBLICA NA SUBNET PUBLICA
...
## CRIA UM NAT APARTIR DO IP PUBLICO
...
resource "aws_flow_log" "example" {
  log_destination      = "arn:aws:s3:::grmo-clc13-network-terraform-state"
